...
# Classes to get and parse Periscope broadcast and chat info
...
class PeriscopeLiveChat
  ...
  # class method to perform all the necessary periscope queries to get the live chat info of user's broadcast
  #
  def self.get_periscope_chat_connection(user : String)
  ...
  #
  def self.get_periscope_data(url : String)
  ...
  #
  def self.extract_broadcast_id(response_data)
  ...
  #
  def self.extract_user_id(user, response_data)
  ...
  #
  def self.extract_session_id(response_data)
  ...
  #
  def self.extract_most_recent_broadcast_id(response_data)
  ...
  #
  def self.extract_chat_url_access_token(response_data)
  ...
  #
  def self.extract_chat_endpoint(response_data) : String
  ...
  #
  def self.extract_chat_access_token(response_data) : String
    e = ChatAccessResponse.from_json(response_data)
  ...
  # method to get the listening socket
  #
  def listening_socket
    @listening_socket
  end

  # method to get the periscope socket
  #
  def periscope_socket
    @listening_socket
  end

  # method to get the broadcast ID
  #
  def broadcast_id
    @broadcast_id
  end
